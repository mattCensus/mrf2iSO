    ...
    <xsl:template name="browseUrl">
        ...
        <xsl:choose>
            <xsl:when test="contains($theme,'AIANNH')">
                <xsl:element name="gco:CharacterString">https://tigerweb.geo.census.gov/arcgis/services/TIGERweb/tigerWMS_Current/MapServer/WMSServer?REQUEST=GetMap&amp;SERVICE=WMS&amp;VERSION=1.3.0&amp;LAYERS=Off-Reservation Trust Lands,Off-Reservation Trust Lands Labels,State American Indian Reservations,State American Indian Reservations Labels,Hawaiian Home Lands,Hawaiian Home Lands Labels,Alaska Native Village Statistical Areas,Alaska Native Village Statistical Areas Labels,Federal American Indian Reservations,Federal American Indian Reservations Labels,Tribal Subdivisions,Tribal Subdivisions Labels,Oklahoma Tribal Statistical Areas,Oklahoma Tribal Statistical Areas Labels&amp;STYLES=default,default,default,default,default,default,default,default,default,default,default,default,default,default&amp;FORMAT=image/svg+xml&amp;BGCOLOR=0xFFFFFF&amp;TRANSPARENT=TRUE&amp;CRS=EPSG:4326&amp;BBOX=+31.7134386,-112.0355607,+32.17347503,-111.6407790&amp;WIDTH=891&amp;HEIGHT=751</xsl:element>
            </xsl:when>
            <xsl:when test="contains($theme,'American Indian Tribal Subdivision')">
                <xsl:element name="gco:CharacterString">https://tigerweb.geo.census.gov/arcgis/services/TIGERweb/tigerWMS_Current/MapServer/WMSServer?REQUEST=GetMap&amp;SERVICE=WMS&amp;VERSION=1.3.0&amp;LAYERS=Tribal Subdivisions,Tribal Subdivisions Labels,Oklahoma Tribal Statistical Areas,Oklahoma Tribal Statistical Areas Labels&amp;STYLES=default,default,default,default&amp;FORMAT=image/svg+xml&amp;BGCOLOR=0xFFFFFF&amp;TRANSPARENT=TRUE&amp;CRS=EPSG:4326&amp;BBOX=+31.7134386,-112.0355607,+32.17347503,-111.6407790&amp;WIDTH=891&amp;HEIGHT=751</xsl:element>
            </xsl:when>
            <xsl:when test="contains($theme,'CBSA')">
                <xsl:element name="gco:CharacterString">https://tigerweb.geo.census.gov/arcgis/services/TIGERweb/tigerWMS_Current/MapServer/WMSServer?REQUEST=GetMap&amp;SERVICE=WMS&amp;VERSION=1.3.0&amp;LAYERS=Metropolitan Statistical Areas,Metropolitan Statistical Areas Labels,Micropolitan Statistical Areas,Micropolitan Statistical Areas Labels&amp;STYLES=default,default,default,default&amp;FORMAT=image/svg+xml&amp;BGCOLOR=0xFFFFFF&amp;TRANSPARENT=TRUE&amp;CRS=EPSG:4326&amp;BBOX=41.187053,-73.508142,42.88679,-69.858861&amp;WIDTH=891&amp;HEIGHT=751</xsl:element>
            </xsl:when>
            <xsl:when test="contains($theme,'Congressional District')">
                <xsl:element name="gco:CharacterString">https://tigerweb.geo.census.gov/arcgis/services/TIGERweb/tigerWMS_Current/MapServer/WMSServer?REQUEST=GetMap&amp;SERVICE=WMS&amp;VERSION=1.3.0&amp;LAYERS=115th Congressional Districts,115th Congressional Districts Labels&amp;STYLES=default,default&amp;FORMAT=image/svg+xml&amp;BGCOLOR=0xFFFFFF&amp;TRANSPARENT=TRUE&amp;CRS=EPSG:4326&amp;BBOX=32.860571,-113.5097542,46.389131,-113.509754&amp;WIDTH=1090&amp;HEIGHT=751</xsl:element>
            </xsl:when>
            <xsl:when test="contains($theme,'CNECTA')">
                <xsl:element name="gco:CharacterString">https://tigerweb.geo.census.gov/arcgis/services/TIGERweb/tigerWMS_Current/MapServer/WMSServer?REQUEST=GetMap&amp;SERVICE=WMS&amp;VERSION=1.3.0&amp;LAYERS=Combined New England City and Town Areas,Combined New England City and Town Areas Labels&amp;STYLES=default,default&amp;FORMAT=image/svg+xml&amp;BGCOLOR=0xFFFFFF&amp;TRANSPARENT=TRUE&amp;CRS=EPSG:4326&amp;BBOX= 41.143086,-72.115419,42.131168,-68.9292064&amp;WIDTH=891&amp;HEIGHT=751</xsl:element>
            </xsl:when>
            <xsl:when test="contains($theme,'Current County and Equivalent')">
                <xsl:element name="gco:CharacterString">https://tigerweb.geo.census.gov/arcgis/services/TIGERweb/tigerWMS_Current/MapServer/WMSServer?REQUEST=GetMap&amp;SERVICE=WMS&amp;VERSION=1.3.0&amp;LAYERS=Counties,Counties Labels&amp;STYLES=default,default&amp;FORMAT=image/svg+xml&amp;BGCOLOR=0xFFFFFF&amp;TRANSPARENT=TRUE&amp;CRS=EPSG:4326&amp;BBOX=41.187053,-73.508142,42.88679,-69.858861&amp;WIDTH=891&amp;HEIGHT=751</xsl:element>
            </xsl:when>
            <xsl:when test="contains($theme,'CSA')">
                <xsl:element name="gco:CharacterString">https://tigerweb.geo.census.gov/arcgis/services/TIGERweb/tigerWMS_Current/MapServer/WMSServer?REQUEST=GetMap&amp;SERVICE=WMS&amp;VERSION=1.3.0&amp;LAYERS=Combined Statistical Areas,Combined Statistical Areas Labels&amp;STYLES=default,default&amp;FORMAT=image/svg+xml&amp;BGCOLOR=0xFFFFFF&amp;TRANSPARENT=TRUE&amp;CRS=EPSG:4326&amp;BBOX=32.860571,-114.5097542,46.389131,-110.509754&amp;WIDTH=891&amp;HEIGHT=751</xsl:element>
            </xsl:when>
            ...
            <xsl:when test="contains($theme,'Current New England City and Town Area')">
                <xsl:element name="gco:CharacterString">https://tigerweb.geo.census.gov/arcgis/services/TIGERweb/tigerWMS_Current/MapServer/WMSServer?REQUEST=GetMap&amp;SERVICE=WMS&amp;VERSION=1.3.0&amp;LAYERS=Micropolitan New England City and Town Areas,Micropolitan New England City and Town Areas Labels,Metropolitan New England City and Town Areas,Metropolitan New England City and Town Areas Labels&amp;STYLES=default,default,default,default&amp;FORMAT=image/svg+xml&amp;BGCOLOR=0xFFFFFF&amp;TRANSPARENT=TRUE&amp;CRS=EPSG:4326&amp;BBOX=41.187053,-72.508142,42.88679,-69.858861&amp;WIDTH=891&amp;HEIGHT=751</xsl:element>
            </xsl:when>
            <xsl:when test="contains($theme,'NECTA Division')">
                <xsl:element name="gco:CharacterString">https://tigerweb.geo.census.gov/arcgis/services/TIGERweb/tigerWMS_Current/MapServer/WMSServer?REQUEST=GetMap&amp;SERVICE=WMS&amp;VERSION=1.3.0&amp;LAYERS=New England City and Town Area Divisions,New England City and Town Area  Divisions Labels&amp;STYLES=default,default&amp;FORMAT=image/svg+xml&amp;BGCOLOR=0xFFFFFF&amp;TRANSPARENT=TRUE&amp;CRS=EPSG:4326&amp;BBOX=41.187053,-72.508142,42.88679,-69.858861&amp;WIDTH=891&amp;HEIGHT=751</xsl:element>
            </xsl:when>
            ...
            <xsl:when test="contains($theme,'Current State and Equivalent')">
                <xsl:element name="gco:CharacterString">https://tigerweb.geo.census.gov/arcgis/services/TIGERweb/tigerWMS_Current/MapServer/WMSServer?REQUEST=GetMap&amp;SERVICE=WMS&amp;VERSION=1.3.0&amp;LAYERS=States,States Labels&amp;STYLES=default,default&amp;FORMAT=image/svg+xml&amp;BGCOLOR=0xFFFFFF&amp;TRANSPARENT=TRUE&amp;CRS=EPSG:4326&amp;BBOX=32.860571,-113.5097542,46.389131,-113.509754&amp;WIDTH=891&amp;HEIGHT=751</xsl:element>                 
            </xsl:when>
            <xsl:when test="contains($theme,'Tribal Block Group')">
                <xsl:element name="gco:CharacterString">https://tigerweb.geo.census.gov/arcgis/services/TIGERweb/tigerWMS_Current/MapServer/WMSServer?REQUEST=GetMap&amp;SERVICE=WMS&amp;VERSION=1.3.0&amp;LAYERS=Tribal Block Groups,Tribal Block Groups Labels&amp;STYLES=default,default&amp;FORMAT=image/svg+xml&amp;BGCOLOR=0xFFFFFF&amp;TRANSPARENT=TRUE&amp;CRS=EPSG:4326&amp;BBOX=32.501202,-112.203736,32.65104,-111.448354&amp;WIDTH=1090&amp;HEIGHT=751</xsl:element>
            </xsl:when>
            <xsl:when test="contains($theme,'Tribal Census Tract')">
                <xsl:element name="gco:CharacterString">https://tigerweb.geo.census.gov/arcgis/services/TIGERweb/tigerWMS_Current/MapServer/WMSServer?REQUEST=GetMap&amp;SERVICE=WMS&amp;VERSION=1.3.0&amp;LAYERS=Tribal Census Tracts,Tribal Census Tracts Labels&amp;STYLES=default, default&amp;FORMAT=image/svg+xml&amp;BGCOLOR=0xFFFFFF&amp;TRANSPARENT=TRUE&amp;CRS=EPSG:4326&amp;BBOX= 32.501202,-112.203736,33.466104,-110.448354&amp;WIDTH=1090&amp;HEIGHT=751</xsl:element>
            </xsl:when>
